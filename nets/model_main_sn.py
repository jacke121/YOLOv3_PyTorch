...
from nets import switchable_norm as switch_norm
from .backbone import backbone_fn


class ModelMain_SN(nn.Module):
    def __init__(self, config, is_training=True,using_moving_average=True):
        super(ModelMain_SN, self).__init__()
        self.config = config
    ...
    def _make_cbl(self, _in, _out, ks,using_moving_average=True):
        ...
        return nn.Sequential(OrderedDict([
            ...
            ("bn", switch_norm.SwitchNorm(_out, using_moving_average=using_moving_average,last_gamma=True)),
