...
from voc import parse_voc_annotation_new
import json
...
def get_anchor(config,num_anchors,org_path):
    train_imgs, train_labels = parse_voc_annotation_new(
        config['model']['labels'],
        org_path=org_path
    )
...
if __name__ == '__main__':
    ...
    num_anchors = 5
    org_path = r'\\192.168.55.73\team-CV\dataset\origin_all_datas\_2train'
    ...
    # config['model']['labels'] = ["m_horizontal","m_vertical","m_incline","m_head","m_back","m_bend","m_front"]

    get_anchor(config,num_anchors,org_path)

# 8 0.0195348512039277
# new 16,24, 23,39, 25,84, 31,67, 43,55, 46,38, 60,103, 73,235
# 9 0.018861201970176975
# new 16,24, 23,39, 25,85, 30,66, 42,54, 46,37, 55,80, 60,123, 69,245